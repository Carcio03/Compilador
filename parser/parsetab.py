...
_lr_productions = [
  ...
  ('program -> PROGRAM LBRACE declarations statements RBRACE','program',5,'p_program','parser.py',55),
  ('declarations -> declarations declaration','declarations',2,'p_declarations','parser.py',59),
  ('declarations -> declaration','declarations',1,'p_declarations','parser.py',60),
  ('declarations -> empty','declarations',1,'p_declarations','parser.py',61),
  ('declaration -> type var_list SEMICOLON','declaration',3,'p_declaration','parser.py',70),
  ('var_list -> var_list COMMA IDENTIFIER','var_list',3,'p_var_list','parser.py',74),
  ('var_list -> var_list COMMA IDENTIFIER ASSIGN expression','var_list',5,'p_var_list','parser.py',75),
  ('var_list -> IDENTIFIER','var_list',1,'p_var_list','parser.py',76),
  ('var_list -> IDENTIFIER ASSIGN expression','var_list',3,'p_var_list','parser.py',77),
  ('type -> INT','type',1,'p_type','parser.py',88),
  ('type -> FLOAT','type',1,'p_type','parser.py',89),
  ('type -> BOOL','type',1,'p_type','parser.py',90),
  ('statements -> statements statement','statements',2,'p_statements','parser.py',94),
  ('statements -> statement','statements',1,'p_statements','parser.py',95),
  ('statements -> empty','statements',1,'p_statements','parser.py',96),
  ('statement -> assignment','statement',1,'p_statement','parser.py',105),
  ('statement -> if_statement','statement',1,'p_statement','parser.py',106),
  ('statement -> while_statement','statement',1,'p_statement','parser.py',107),
  ('statement -> do_while_statement','statement',1,'p_statement','parser.py',108),
  ('statement -> write_statement','statement',1,'p_statement','parser.py',109),
  ('statement -> read_statement','statement',1,'p_statement','parser.py',110),
  ('statement -> block','statement',1,'p_statement','parser.py',111),
  ('statement -> increment','statement',1,'p_statement','parser.py',112),
  ('statement -> decrement','statement',1,'p_statement','parser.py',113),
  ('assignment -> IDENTIFIER ASSIGN expression SEMICOLON','assignment',4,'p_assignment','parser.py',117),
  ('increment -> IDENTIFIER PLUS PLUS SEMICOLON','increment',4,'p_increment','parser.py',122),
  ('decrement -> IDENTIFIER MINUS MINUS SEMICOLON','decrement',4,'p_decrement','parser.py',126),
  ('if_statement -> IF expression block else_part FI','if_statement',5,'p_if_statement','parser.py',130),
  ('if_statement -> IF expression statement else_part FI','if_statement',5,'p_if_statement','parser.py',131),
  ('else_part -> ELSE block','else_part',2,'p_else_part','parser.py',135),
  ('else_part -> ELSE statement','else_part',2,'p_else_part','parser.py',136),
  ('else_part -> empty','else_part',1,'p_else_part','parser.py',137),
  ('while_statement -> WHILE expression LBRACE statements RBRACE','while_statement',5,'p_while_statement','parser.py',144),
  ('do_while_statement -> DO LBRACE statements RBRACE WHILE LPAREN expression RPAREN SEMICOLON','do_while_statement',9,'p_do_while_statement','parser.py',148),
  ('write_statement -> WRITE expression SEMICOLON','write_statement',3,'p_write_statement','parser.py',152),
  ('read_statement -> READ IDENTIFIER SEMICOLON','read_statement',3,'p_read_statement','parser.py',156),
  ('block -> LBRACE statements RBRACE','block',3,'p_block','parser.py',160),
  ...
  ('expression -> expression LT expression','expression',3,'p_expression_binop','parser.py',169),
  ('expression -> expression GT expression','expression',3,'p_expression_binop','parser.py',170),
  ('expression -> expression LE expression','expression',3,'p_expression_binop','parser.py',171),
  ('expression -> expression GE expression','expression',3,'p_expression_binop','parser.py',172),
  ('expression -> expression NE expression','expression',3,'p_expression_binop','parser.py',173),
  ('expression -> expression AND expression','expression',3,'p_expression_binop','parser.py',174),
  ('expression -> expression OR expression','expression',3,'p_expression_binop','parser.py',175),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','parser.py',179),
  ('expression -> NOT expression','expression',2,'p_expression_not','parser.py',183),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','parser.py',187),
  ('expression -> NUMBER','expression',1,'p_expression_number','parser.py',191),
  ('expression -> IDENTIFIER','expression',1,'p_expression_identifier','parser.py',195),
  ('expression -> TRUE','expression',1,'p_expression_bool','parser.py',199),
  ('expression -> FALSE','expression',1,'p_expression_bool','parser.py',200),
